...
class a
{
    char bus_no[5], driver[10], arrival[5], depart[5], from[10], to[10], seat[4][8][10];
...
void a::install()
{
    ...
    cin >> bus[p].driver;
    cout << "Enter arrival time of bus:\n";
    cin >> bus[p].arrival;
    cout << "Enter departure time of bus:\n";
    cin >> bus[p].depart;
    cout << "Enter the place where you want to start your jurnery:  \n";
    cin >> bus[p].from;
